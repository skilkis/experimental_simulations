...
% Input libraries
NI_TDM_DLL_Path = fullfile(parent_dir, "bin" , "nilibddc.dll");
NI_TDM_H_Path = fullfile(parent_dir, "include" , "nilibddc_m.h");
...
[err,~,filenamelen]=calllib(...
    libname,...
    'DDC_GetFileStringPropertyLength',...
    file,...
    DDC_FILE_NAME,...
    filenamelenIn);
